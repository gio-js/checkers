 ...
 */
int analyzeMovementPath(t_GameSession *clone, t_AvailableMovement movement, int level) {
	int score = 0;
	...
	while (currentPathAvailableMovements.SourceX >= 0) {
		...
		score += analyzeMovementPath(innerClone, currentPathAvailableMovements, level - 1);
//		if (score > 0)
//		{
//			int a = 1;
//		}
...
t_AvailableMovement findBestAvailableMovement(t_GameSession *gameSession) {
	...
	bestMovement.SourceX = -1;
	bestMovement.SourceY = -1;
	bestMovement.DestinationX = -1;
	bestMovement.DestinationY = -1;
	...
	while (currentPathAvailableMovements.SourceX >= 0) {
		...
		movementScore = analyzeMovementPath(clone, currentPathAvailableMovements, AI_DEEP_PATH_ANALYSIS);
